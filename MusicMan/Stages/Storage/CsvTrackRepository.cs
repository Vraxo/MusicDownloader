...
internal sealed class CsvTrackRepository
{
    private static readonly string[] Headers = [
        "source", "title", "artist", "album", "date",
        "track_number", "album_artist", "composer", "cover", "range", "tempo", "loop", "tags"
    ];
    ...
    private static async Task CreateEmptyDatabaseAsync(string csvPath)
    {
        try
        {
    ...
    private static async Task WriteAllTracksAsync(string csvPath, List<Track> tracks)
    {
