...
namespace MusicMan.Stages.Fetching;
...
internal static class UserInput
{
    ...
    public static string? GetInputFilePath()
    {
        ...
        {
            Log.Error(
                $"Directory '{DataDir}' not found. " +
                $"Please create it and place your audio files inside.");
    ...
    {
        Log.Action(
            "Enter tempo change percentage (e.g., 110 for 10% faster, 95 for 5% slower). " +
    ...
    {
        Log.Action(
            "Enter trim range (e.g., 00:15-01:30 or 15-90). " +
            "Leave empty for no trimming:");
